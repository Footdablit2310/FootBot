...
async def setup(bot: commands.Bot) -> None:
    """Prepares the bot"""
    command_list_add(Roster.create_roster.name, ROSTER)
    command_list_add(Roster.delete_roster.name, ROSTER)
    command_list_add(Roster.add_to_roster.name, ROSTER)
    command_list_add(Roster.remove_from_roster.name, ROSTER)
