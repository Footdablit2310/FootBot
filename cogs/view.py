...
from utils.storage import get_guild_data_r, command_list_add, ROSTER
...
async def setup(bot: commands.Bot) -> None:
    """This handles setup"""
    command_list_add(View.view_event.name, ROSTER)
    command_list_add(View.view_roster.name, ROSTER)
